...
public class ProblemInstanceSingleClient implements Comparable<ProblemInstanceSingleClient>  {
    ...
    public int compareTo(ProblemInstanceSingleClient pi) {
    ...
    public ProblemInstanceSingleClient(double GivenLatency, double GivenBandwidth, int n, int f, int N) {
    ...
    public ProblemInstanceSingleClient(ProblemInstanceSingleClient problemInstanceSingleDevice) {
